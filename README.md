...
* Adjust your screen **W**idth/**H**eight/**S**cale/**C**olors/**Q**uality to fit in your old browser.
...
* Prefer JPEG over GIF or PNG if your browser supports it. JPEG is much faster than GIF or PNG because of the image size. GIF requires more additional processing on both client and server than JPEG.
...
**C** is colors, for GIF images only (unused in PNG and JPEG)

**Q** is quality, for JPEG images only (unused in PNG and GIF)
